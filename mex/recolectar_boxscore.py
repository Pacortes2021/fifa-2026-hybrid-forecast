"""
Recolecta el BOX SCORE detallado de cada partido de la Liga MX desde ESPN (endpoint summary):
...
Uso:  python3 recolectar_boxscore.py   -> mex/data/box_score.csv
"""
...
SB = "https://site.api.espn.com/apis/site/v2/sports/soccer/mex.1/scoreboard"
...
def recolectar():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=15) as executor:
        # Usar map pero con control para guardar cada 100 partidos
        ...
        for future in concurrent.futures.as_completed(future_to_ev):
            ...
            if count % 100 == 0:
                ...
                # Guardado parcial inmediato para resiliencia
