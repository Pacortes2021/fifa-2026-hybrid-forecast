"""
Aplicación Streamlit para la simulación y predicciones de la Süper Lig (Turquía).
...
# Insertar el directorio tur en el path para asegurar la importación del motor
...
.main-title { text-align:center; font-size:2.8rem; font-weight:800;
    background:linear-gradient(135deg,#E30A17,#A00010,#1A1A1A); -webkit-background-clip:text;
...
.card-title { font-size:1.25rem; font-weight:700; color:#E30A17;
...
# Emojis e identidades visuales de los clubes turcos
TEAM_DETAILS = {
    "Galatasaray": {"flag": "🟡🔴", "color": "#aa0031"},
    "Fenerbahce": {"flag": "🟡🔵", "color": "#ffff00"},
    "Besiktas": {"flag": "⚫⚪", "color": "#1a1a1a"},
    "Trabzonspor": {"flag": "🟤🔵", "color": "#5699eb"},
    "Istanbul Basaksehir": {"flag": "🟠🔵", "color": "#ff6600"},
    "Samsunspor": {"flag": "🔴⚪", "color": "#e30a17"},
    "Eyupspor": {"flag": "🟣🟡", "color": "#4a154b"},
    "Kasimpasa": {"flag": "🔵⚪", "color": "#003399"},
    "Alanyaspor": {"flag": "🟠🟢", "color": "#ff7900"},
    "Goztepe": {"flag": "🟡🔴", "color": "#e30a17"},
    "Caykur Rizespor": {"flag": "🟢🔵", "color": "#008000"},
    "Antalyaspor": {"flag": "🔴⚪", "color": "#e30a17"},
    "Gaziantep FK": {"flag": "🔴⚫", "color": "#e30a17"},
    "Konyaspor": {"flag": "🟢⚪", "color": "#288a00"},
    "Kayserispor": {"flag": "🟡🔴", "color": "#e30a17"},
    "Sivasspor": {"flag": "🔴⚪", "color": "#bc0e17"},
    "Bodrum FK": {"flag": "🟢⚪", "color": "#006400"},
    "Adana Demirspor": {"flag": "🔵⚪", "color": "#000080"},
    "Hatayspor": {"flag": "🔴⚪", "color": "#e30a17"},
    "Fatih Karagümrük": {"flag": "🔴⚫", "color": "#e30a17"},
    "Ankaragucu": {"flag": "🟡🔵", "color": "#ffcc00"},
    "Pendikspor": {"flag": "🔴⚪", "color": "#e30a17"},
    "Istanbulspor": {"flag": "🟡⚫", "color": "#ffcc00"},
    "Giresunspor": {"flag": "🟢⚪", "color": "#4cbb17"},
    "Umraniyespor": {"flag": "🔴⚪", "color": "#e30a17"},
    "Kocaelispor": {"flag": "🟢⚫", "color": "#008000"},
    "Genclerbirligi": {"flag": "🔴⚫", "color": "#e91b23"},
    "Corum FK": {"flag": "🔴⚫", "color": "#e30a17"},
    "Amed SFK": {"flag": "🔴🟢", "color": "#e30a17"},
    "Erzurum BB": {"flag": "🔵⚪", "color": "#003399"},
    "Altay Izmir": {"flag": "⚫⚪", "color": "#1a1a1a"},
    "Yeni Malatyaspor": {"flag": "🟡⚫", "color": "#ffcc00"},
    "Denizlispor": {"flag": "🟢⚫", "color": "#0d923f"}
}
...
def run_app():
    ...
    M = get_motor()
    if M is None:
        st.error("No se encontraron datos históricos de la Süper Lig. Ejecuta la recolección primero.")
        return

    tracker = M["tracker"]
    equipos_data = M.get("equipos", {})

    st.markdown('<div class="main-title">🇹🇷 Trendyol Süper Lig Predictor</div>', unsafe_allow_html=True)
    ...
    with tab1:
        ...
        if not fixture_disp.empty:
            st.markdown("#### ⚡ Próximos Partidos Oficiales de Süper Lig")
        ...
        if local == visita:
            ...
            with st.expander("🎲 Matriz de Marcador Exacto (Dixon-Coles)"):
                ...
                df_mat = pd.DataFrame(mat * 100, index=[f"{local} {i}" for i in range(5)], columns=[f"{visita} {j}" for j in range(5)])
                st.dataframe(df_mat.style.format("{:.1f}%").background_gradient(cmap="OrRd"), width='stretch')
    ...
    with tab2:
        ...
        with col_t2:
            ...
            df_mc = simular_liga(M, "sim_key_tur", modelo_tipo)
        ...
        st.info("ℹ️ **Reglas de Süper Lig**: Puestos 1-2 clasifican a UEFA Champions League, 3 a Europa League, 4 a Conference League. Los últimos 4 puestos descienden a 1. Lig.")
    ...
    with tab3:
        ...
        if rf_step and hasattr(rf_step, "feature_importances_"):
            ...
            ax.barh(df_imp["Variable"][::-1], df_imp["Importancia"][::-1], color="#E30A17")
