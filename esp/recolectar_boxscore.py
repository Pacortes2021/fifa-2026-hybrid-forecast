"""
Recolecta el BOX SCORE detallado de cada partido de LaLiga desde ESPN (endpoint summary):
...
SB = "https://site.api.espn.com/apis/site/v2/sports/soccer/esp.1/scoreboard"
SUM = "https://site.api.espn.com/apis/site/v2/sports/soccer/esp.1/summary"
