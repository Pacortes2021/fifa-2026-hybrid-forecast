...
def cargar_y_entrenar():
    ...
    pipe_rf_base = Pipeline([("scale", StandardScaler()), ("rf", RandomForestClassifier(max_depth=3, n_estimators=500, min_samples_split=30, random_state=42, n_jobs=-1))])
    ...
    pipe_rf = Pipeline([("scale", StandardScaler()), ("rf", RandomForestClassifier(max_depth=3, n_estimators=500, min_samples_split=30, random_state=42, n_jobs=-1))])
