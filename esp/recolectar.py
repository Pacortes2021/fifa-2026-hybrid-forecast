"""
Recolector de la Primera División de España (LaLiga) desde la API pública de ESPN (liga 'esp.1').
Construye el histórico de partidos (para entrenar el modelo) y el fixture restante de 2026.

Uso:  python3 recolectar.py        -> escribe esp/data/partidos.csv y esp/data/fixture.csv
"""
