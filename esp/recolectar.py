...
def recolectar():
    ...
    if not todo:
        print("No se pudieron recolectar partidos de España.")
        return
    ...
    print(f"\nGuardado España: partidos.csv ({len(jugados)} jugados)")
    print(f"Guardado España: fixture.csv ({len(fixture)} por jugar)")
