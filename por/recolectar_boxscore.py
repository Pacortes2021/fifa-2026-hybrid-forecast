"""
Recolecta el BOX SCORE detallado de cada partido de la Primeira Liga desde ESPN (endpoint summary):
Recupera las 28 estadísticas disponibles en el boxscore (tiros, posesión, pases, etc.).
Usa ThreadPoolExecutor para descargar en paralelo. Incremental: no re-pide partidos ya guardados.

Uso:  python3 recolectar_boxscore.py   -> por/data/box_score.csv
"""
...
SB = "https://site.api.espn.com/apis/site/v2/sports/soccer/por.1/scoreboard"
SUM = "https://site.api.espn.com/apis/site/v2/sports/soccer/por.1/summary"
...
def recolectar():
    ...
    if nuevos_resultados:
        ...
        print("No se agregaron partidos nuevos.")
