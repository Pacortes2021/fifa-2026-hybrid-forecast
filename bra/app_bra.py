...
st.set_page_config(
    page_title="Simulador Brasileirão 2026",
    page_icon="🇧🇷",
    layout="wide"
)
...
with tab1:
    ...
    with c1:
        a = st.selectbox("Equipo Local", equipos_activos, index=equipos_activos.index("Flamengo") if "Flamengo" in equipos_activos else 0, key="sel_a")
    with cvs:
        st.markdown('<div class="vs-text">VS</div>', unsafe_allow_html=True)
    with c2:
        b = st.selectbox("Equipo Visitante", equipos_activos, index=equipos_activos.index("Palmeiras") if "Palmeiras" in equipos_activos else 0, key="sel_b")
