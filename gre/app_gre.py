"""
Aplicación Streamlit para la simulación y predicciones de la Greek Super League (Grecia).
...
# Insertar el directorio gre en el path para asegurar la importación del motor
...
.main-title { text-align:center; font-size:2.8rem; font-weight:800;
    background:linear-gradient(135deg,#0D5EAF,#003366,#1A1A1A); -webkit-background-clip:text;
...
.card-title { font-size:1.25rem; font-weight:700; color:#0D5EAF;
...
# Emojis e identidades visuales de los clubes griegos
TEAM_DETAILS = {
    "Olympiacos": {"flag": "🔴⚪", "color": "#d81e05"},
    "Panathinaikos": {"flag": "🟢⚪", "color": "#13783c"},
    "PAOK": {"flag": "⚫⚪", "color": "#000000"},
    "AEK Athens": {"flag": "🟡⚫", "color": "#ffcc00"},
    "Aris": {"flag": "🟡⚫", "color": "#ffcc00"},
    "OFI Crete": {"flag": "⚫⚪", "color": "#000000"},
    "Asteras Tripoli": {"flag": "🟡🔵", "color": "#004b87"},
    "Atromitos": {"flag": "🔵⚪", "color": "#003399"},
    "Panetolikos": {"flag": "🟡🔵", "color": "#004b87"},
    "Volos NFC": {"flag": "🔴🔵", "color": "#c8102e"},
    "Panserraikos FC": {"flag": "🔴⚪", "color": "#c8102e"},
    "Levadiakos": {"flag": "🟢🔵", "color": "#00843d"},
    "Lamia": {"flag": "🔵⚪", "color": "#003399"},
    "Athens Kallithea": {"flag": "🔵⚪", "color": "#003399"},
    "Pas Giannina": {"flag": "🔵⚪", "color": "#003399"},
    "Kifisia": {"flag": "🔵⚪", "color": "#003399"},
    "Ionikos FC": {"flag": "🔵⚪", "color": "#003399"},
    "Apollon Smyrni": {"flag": "🔵⚪", "color": "#003399"},
    "Larissa FC": {"flag": "🟣⚪", "color": "#800000"},
    "Iraklis": {"flag": "🔵⚪", "color": "#003399"},
    "Kalamata": {"flag": "⚫⚪", "color": "#000000"}
}
...
def run_app():
    ...
    M = get_motor()
    if M is None:
        st.error("No se encontraron datos históricos de la Greek Super League. Ejecuta la recolección primero.")
        return

    tracker = M["tracker"]
    equipos_data = M.get("equipos", {})

    st.markdown('<div class="main-title">🇬🇷 Greek Super League Predictor</div>', unsafe_allow_html=True)
    ...
    with tab1:
        ...
        if not fixture_disp.empty:
            st.markdown("#### ⚡ Próximos Partidos Oficiales de Greek Super League")
    ...
    with tab2:
        ...
        with col_t2:
            ...
            df_mc = simular_liga(M, "sim_key_gre", modelo_tipo)
        ...
        st.info("ℹ️ **Reglas de Greek Super League**: Los 6 mejores equipos disputan la Ronda de Campeonato (1º y 2º a Champions League, 3º a Europa League, 4º a Conference League). Los 8 últimos disputan el Playoff de Descenso, donde los puestos 13º y 14º descienden directo a la Super League 2.")
    ...
    with tab3:
        ...
        if rf_step and hasattr(rf_step, "feature_importances_"):
            ...
            ax.barh(df_imp["Variable"][::-1], df_imp["Importancia"][::-1], color="#0D5EAF")
