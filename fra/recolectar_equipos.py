"""
Recolector de equipos de la Ligue 1 desde el endpoint /teams de ESPN (fra.1 y fra.2 para clubes históricos).
...
def recolectar():
    ...
    # Recolectar de fra.1 y fra.2
    for slug in ["fra.1", "fra.2"]:
