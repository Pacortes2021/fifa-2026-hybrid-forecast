"""
Recolecta el BOX SCORE detallado de cada partido de la Ligue 1 desde ESPN (endpoint summary):
...
Uso:  python3 recolectar_boxscore.py   -> fra/data/box_score.csv
"""
...
SB = "https://site.api.espn.com/apis/site/v2/sports/soccer/fra.1/scoreboard"
SUM = "https://site.api.espn.com/apis/site/v2/sports/soccer/fra.1/summary"
