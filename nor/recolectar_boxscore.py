"""
Recolecta el BOX SCORE detallado de cada partido de la Norwegian Eliteserien desde ESPN:
...
SB = "https://site.api.espn.com/apis/site/v2/sports/soccer/nor.1/scoreboard"
SUM = "https://site.api.espn.com/apis/site/v2/sports/soccer/nor.1/summary"
...
def recolectar():
    ...
    if nuevos_resultados:
        ...
        print(f"Éxito: {len(df_final)} partidos totales guardados en {path}")
        return df_final
    else:
