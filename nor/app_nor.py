"""
Aplicación Streamlit para la simulación y predicciones de la Norwegian Eliteserien (Noruega).
...
# Insertar el directorio nor en el path para asegurar la importación del motor
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import motor as mo
import recolectar as rec
import recolectar_boxscore as rec_box

# Estilizado CSS Premium con paleta de colores de Noruega (Rojo Carmesí, Azul Marino, Blanco)
st.markdown("""
<style>
@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800&display=swap');
html, body, [class*="css"] { font-family: 'Outfit', sans-serif; }
.main-title { text-align:center; font-size:2.8rem; font-weight:800;
    background:linear-gradient(135deg,#BA0C2F,#00205B,#1A1A1A); -webkit-background-clip:text;
...
.card-title { font-size:1.25rem; font-weight:700; color:#BA0C2F;
...
# Emojis e identidades visuales de los clubes noruegos
TEAM_DETAILS = {
    "Bodo/Glimt": {"flag": "🟡⚫", "color": "#FCEE33"},
    "Molde": {"flag": "🔵⚪", "color": "#000099"},
    "SK Brann": {"flag": "🔴⚪", "color": "#FF0000"},
    "Rosenborg": {"flag": "⚪⚫", "color": "#000000"},
    "Viking FK": {"flag": "🔵⚪", "color": "#000080"},
    "Lillestrom": {"flag": "🟡⚫", "color": "#E8E337"},
    "Vålerenga": {"flag": "🔵🔴", "color": "#003399"},
    "Tromso": {"flag": "🔴⚪", "color": "#C8102E"},
    "Fredrikstad": {"flag": "🔴⚪", "color": "#C8102E"},
    "Stromsgodset": {"flag": "🔵⚪", "color": "#003399"},
    "Sarpsborg FK": {"flag": "🔵⚪", "color": "#0055A5"},
    "Sandefjord": {"flag": "🔵🔴", "color": "#003399"},
    "Hamarkameratene": {"flag": "🟢⚪", "color": "#008000"},
    "Kristiansund BK": {"flag": "🔵⚪", "color": "#00205B"},
    "Haugesund": {"flag": "⚪🔵", "color": "#00205B"},
    "KFUM Oslo": {"flag": "🔴⚪", "color": "#BA0C2F"},
    "Odds BK": {"flag": "⚪⚫", "color": "#000000"},
    "Aalesund": {"flag": "🟠🔵", "color": "#FF6600"},
    "Stabaek": {"flag": "🔵⚪", "color": "#00205B"},
    "Bryne": {"flag": "🔴⚪", "color": "#C8102E"},
    "IK Start": {"flag": "🟡⚫", "color": "#FFCC00"},
    "Mjondalen IF": {"flag": "🟤⚪", "color": "#593315"},
    "FK Jerv": {"flag": "🟡🔵", "color": "#FFCC00"}
}
...
def run_app():
    ...
    M = get_motor()
    if M is None:
        st.error("No se encontraron datos históricos de la Norwegian Eliteserien. Ejecuta la recolección primero.")
        return

    tracker = M["tracker"]
    equipos_data = M.get("equipos", {})

    st.markdown('<div class="main-title">🇳🇴 Norwegian Eliteserien Predictor</div>', unsafe_allow_html=True)
    ...
    with tab1:
        ...
        if not fixture_disp.empty:
            st.markdown("#### ⚡ Próximos Partidos Oficiales de Eliteserien")
    ...
    with tab2:
        ...
        with col_t2:
            ...
            df_mc = simular_liga(M, "sim_key_nor", modelo_tipo)
        ...
        st.info("ℹ️ **Reglas de Eliteserien**: 16 clubes disputan 30 fechas en formato todos contra todos a ida y vuelta. El campeón obtiene cupo para la UEFA Champions League; 2º, 3º y el campeón de la Copa clasifican a torneos europeos (Conference League). Los puestos 15º y 16º descienden directamente a la 1. Divisjon (OBOS-ligaen), mientras el 14º disputa el playoff de descenso.")
    ...
    with tab3:
        ...
        if rf_step and hasattr(rf_step, "feature_importances_"):
            ...
            ax.barh(df_imp["Variable"][::-1], df_imp["Importancia"][::-1], color="#BA0C2F")
