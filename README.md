...
El sistema cuenta con un portal central en **Streamlit** que permite interactuar con **16 aplicaciones de predicción independientes**: la Copa Mundial de la FIFA 2026 y las **15 ligas domésticas más competitivas de Europa y América**.
...
13. 🇧🇷 **Brasileirão Série A** (Brasil)
14. 🇲🇽 **Liga MX** (México — Apertura / Clausura y Liguilla)
15. 🇨🇱 **Primera División de Chile**
16. 🇦🇷 **Liga Profesional de Fútbol Argentino** (Zonas, promedios y tabla anual)
...
├── tests/
│   └── smoke.py              # Suite de smoke tests unificada (15 ligas)
├── .github/workflows/
│   └── refresh_data.yml      # Pipeline CI/CD: ingesta diaria automatizada (06:00 UTC)
│
├── [eng | esp | bund | ita | fra | ned | por | bel | tur | sco | aut | bra | mex | chile | arg]/   # Módulos por liga
